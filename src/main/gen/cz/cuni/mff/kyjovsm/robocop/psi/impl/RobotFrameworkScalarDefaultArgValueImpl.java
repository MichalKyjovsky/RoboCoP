...
public class RobotFrameworkScalarDefaultArgValueImpl extends ASTWrapperPsiElement implements RobotFrameworkScalarDefaultArgValue {

  public RobotFrameworkScalarDefaultArgValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitScalarDefaultArgValue(this);
  }
