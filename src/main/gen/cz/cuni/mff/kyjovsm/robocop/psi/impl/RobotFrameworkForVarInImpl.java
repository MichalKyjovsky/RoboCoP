...
public class RobotFrameworkForVarInImpl extends ASTWrapperPsiElement implements RobotFrameworkForVarIn {

  public RobotFrameworkForVarInImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitForVarIn(this);
  }
