...
public class RobotFrameworkSettingsLineImpl extends ASTWrapperPsiElement implements RobotFrameworkSettingsLine {

  public RobotFrameworkSettingsLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitSettingsLine(this);
  }
