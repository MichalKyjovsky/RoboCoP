...
public class RobotFrameworkSuiteSetupSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkSuiteSetupSetting {

  public RobotFrameworkSuiteSetupSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitSuiteSetupSetting(this);
  }
