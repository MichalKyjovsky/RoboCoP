...
public class RobotFrameworkEllipsesForSettingTableImpl extends ASTWrapperPsiElement implements RobotFrameworkEllipsesForSettingTable {

  public RobotFrameworkEllipsesForSettingTableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitEllipsesForSettingTable(this);
  }
