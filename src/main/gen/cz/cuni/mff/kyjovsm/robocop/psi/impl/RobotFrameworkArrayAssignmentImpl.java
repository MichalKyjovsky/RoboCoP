...
public class RobotFrameworkArrayAssignmentImpl extends ASTWrapperPsiElement implements RobotFrameworkArrayAssignment {

  public RobotFrameworkArrayAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
