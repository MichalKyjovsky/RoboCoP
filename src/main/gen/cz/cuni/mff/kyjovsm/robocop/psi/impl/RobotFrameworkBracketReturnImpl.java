...
public class RobotFrameworkBracketReturnImpl extends ASTWrapperPsiElement implements RobotFrameworkBracketReturn {

  public RobotFrameworkBracketReturnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitBracketReturn(this);
  }
