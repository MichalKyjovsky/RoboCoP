...
public class RobotFrameworkTestTemplateSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkTestTemplateSetting {

  public RobotFrameworkTestTemplateSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestTemplateSetting(this);
  }
