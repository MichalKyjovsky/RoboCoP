...
public class RobotFrameworkAssignableInVariablesTblImpl extends ASTWrapperPsiElement implements RobotFrameworkAssignableInVariablesTbl {

  public RobotFrameworkAssignableInVariablesTblImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitAssignableInVariablesTbl(this);
  }
