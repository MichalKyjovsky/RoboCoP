...
public class RobotFrameworkArgumentsSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkArgumentsSetting {

  public RobotFrameworkArgumentsSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitArgumentsSetting(this);
  }
