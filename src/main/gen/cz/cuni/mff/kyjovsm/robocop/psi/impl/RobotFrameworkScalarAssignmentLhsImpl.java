...
public class RobotFrameworkScalarAssignmentLhsImpl extends ASTWrapperPsiElement implements RobotFrameworkScalarAssignmentLhs {

  public RobotFrameworkScalarAssignmentLhsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitScalarAssignmentLhs(this);
  }
  ...
  @Override
  @Nullable
  public RobotFrameworkScalarAssignment getScalarAssignment() {
    return findChildByClass(RobotFrameworkScalarAssignment.class);
  }

  @Override
  @Nullable
  public RobotFrameworkScalarVariable getScalarVariable() {
    return findChildByClass(RobotFrameworkScalarVariable.class);
  }
