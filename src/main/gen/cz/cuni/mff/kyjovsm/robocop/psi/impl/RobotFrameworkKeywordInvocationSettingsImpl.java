...
public class RobotFrameworkKeywordInvocationSettingsImpl extends ASTWrapperPsiElement implements RobotFrameworkKeywordInvocationSettings {

  public RobotFrameworkKeywordInvocationSettingsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitKeywordInvocationSettings(this);
  }
