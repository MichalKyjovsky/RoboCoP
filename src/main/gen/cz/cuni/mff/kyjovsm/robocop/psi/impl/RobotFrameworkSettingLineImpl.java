...
public class RobotFrameworkSettingLineImpl extends ASTWrapperPsiElement implements RobotFrameworkSettingLine {

  public RobotFrameworkSettingLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitSettingLine(this);
  }
