...
public class RobotFrameworkTestTeardownSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkTestTeardownSetting {

  public RobotFrameworkTestTeardownSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestTeardownSetting(this);
  }
