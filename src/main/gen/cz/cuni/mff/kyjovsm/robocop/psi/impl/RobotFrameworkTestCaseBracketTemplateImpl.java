...
public class RobotFrameworkTestCaseBracketTemplateImpl extends ASTWrapperPsiElement implements RobotFrameworkTestCaseBracketTemplate {

  public RobotFrameworkTestCaseBracketTemplateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestCaseBracketTemplate(this);
  }
