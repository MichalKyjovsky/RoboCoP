...
public class RobotFrameworkSuiteTeardownSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkSuiteTeardownSetting {

  public RobotFrameworkSuiteTeardownSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitSuiteTeardownSetting(this);
  }
