...
public class RobotFrameworkRecurrenceImpl extends ASTWrapperPsiElement implements RobotFrameworkRecurrence {

  public RobotFrameworkRecurrenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitRecurrence(this);
  }
