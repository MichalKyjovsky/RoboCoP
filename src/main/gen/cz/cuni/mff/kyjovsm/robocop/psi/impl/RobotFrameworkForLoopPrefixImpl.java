...
public class RobotFrameworkForLoopPrefixImpl extends ASTWrapperPsiElement implements RobotFrameworkForLoopPrefix {

  public RobotFrameworkForLoopPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitForLoopPrefix(this);
  }
  ...
  @Override
  @NotNull
  public RobotFrameworkSingleVariableList getSingleVariableList() {
    return findNotNullChildByClass(RobotFrameworkSingleVariableList.class);
  }
