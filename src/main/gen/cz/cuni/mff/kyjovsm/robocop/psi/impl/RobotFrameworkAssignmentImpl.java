...
public class RobotFrameworkAssignmentImpl extends ASTWrapperPsiElement implements RobotFrameworkAssignment {

  public RobotFrameworkAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
