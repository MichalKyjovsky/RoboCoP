...
public class RobotFrameworkDoubleBoundForLoopWithStepImpl extends ASTWrapperPsiElement implements RobotFrameworkDoubleBoundForLoopWithStep {

  public RobotFrameworkDoubleBoundForLoopWithStepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitDoubleBoundForLoopWithStep(this);
  }
