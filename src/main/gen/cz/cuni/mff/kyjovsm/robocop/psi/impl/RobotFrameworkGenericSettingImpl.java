...
public class RobotFrameworkGenericSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkGenericSetting {

  public RobotFrameworkGenericSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitGenericSetting(this);
  }
