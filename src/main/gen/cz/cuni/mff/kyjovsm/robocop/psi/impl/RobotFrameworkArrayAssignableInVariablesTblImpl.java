...
public class RobotFrameworkArrayAssignableInVariablesTblImpl extends ASTWrapperPsiElement implements RobotFrameworkArrayAssignableInVariablesTbl {

  public RobotFrameworkArrayAssignableInVariablesTblImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitArrayAssignableInVariablesTbl(this);
  }
