...
public class RobotFrameworkTestSetupSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkTestSetupSetting {

  public RobotFrameworkTestSetupSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestSetupSetting(this);
  }
  ...
  public RobotFrameworkKeywordInvocationSettings getKeywordInvocationSettings() {
    return findNotNullChildByClass(RobotFrameworkKeywordInvocationSettings.class);
  }

  @Override
  @NotNull
  public RobotFrameworkTestSetupToken getTestSetupToken() {
    return findNotNullChildByClass(RobotFrameworkTestSetupToken.class);
  }
