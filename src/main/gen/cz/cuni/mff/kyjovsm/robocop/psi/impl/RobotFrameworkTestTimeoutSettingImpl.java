...
public class RobotFrameworkTestTimeoutSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkTestTimeoutSetting {

  public RobotFrameworkTestTimeoutSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestTimeoutSetting(this);
  }
