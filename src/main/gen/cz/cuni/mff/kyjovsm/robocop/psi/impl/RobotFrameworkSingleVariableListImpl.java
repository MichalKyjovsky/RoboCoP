...
public class RobotFrameworkSingleVariableListImpl extends ASTWrapperPsiElement implements RobotFrameworkSingleVariableList {

  public RobotFrameworkSingleVariableListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitSingleVariableList(this);
  }
  ...
  @Override
  @NotNull
  public List<RobotFrameworkScalarVariable> getScalarVariableList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RobotFrameworkScalarVariable.class);
  }
