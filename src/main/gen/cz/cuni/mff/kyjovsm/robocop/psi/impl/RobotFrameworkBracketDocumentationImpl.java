...
public class RobotFrameworkBracketDocumentationImpl extends ASTWrapperPsiElement implements RobotFrameworkBracketDocumentation {

  public RobotFrameworkBracketDocumentationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitBracketDocumentation(this);
  }
