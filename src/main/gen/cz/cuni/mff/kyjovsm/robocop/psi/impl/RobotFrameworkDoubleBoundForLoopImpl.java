...
public class RobotFrameworkDoubleBoundForLoopImpl extends ASTWrapperPsiElement implements RobotFrameworkDoubleBoundForLoop {

  public RobotFrameworkDoubleBoundForLoopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitDoubleBoundForLoop(this);
  }
