...
public class RobotFrameworkTestCasesTableHeaderImpl extends ASTWrapperPsiElement implements RobotFrameworkTestCasesTableHeader {

  public RobotFrameworkTestCasesTableHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestCasesTableHeader(this);
  }
