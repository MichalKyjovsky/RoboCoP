...
public class RobotFrameworkEllipsesImpl extends ASTWrapperPsiElement implements RobotFrameworkEllipses {

  public RobotFrameworkEllipsesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitEllipses(this);
  }
