...
public class RobotFrameworkReturnSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkReturnSetting {

  public RobotFrameworkReturnSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitReturnSetting(this);
  }
