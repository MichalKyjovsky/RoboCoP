...
public class RobotFrameworkKeywordsTableHeaderImpl extends ASTWrapperPsiElement implements RobotFrameworkKeywordsTableHeader {

  public RobotFrameworkKeywordsTableHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitKeywordsTableHeader(this);
  }
