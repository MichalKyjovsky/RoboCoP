...
public class RobotFrameworkForceTagsSettingImpl extends ASTWrapperPsiElement implements RobotFrameworkForceTagsSetting {

  public RobotFrameworkForceTagsSettingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitForceTagsSetting(this);
  }
