...
public interface RobotFrameworkTypes {
  ...
  IElementType BRACKET_ARGUMENTS = new RobotFrameworkElementType("BRACKET_ARGUMENTS");
  IElementType BRACKET_DOCUMENTATION = new RobotFrameworkElementType("BRACKET_DOCUMENTATION");
  IElementType BRACKET_RETURN = new RobotFrameworkElementType("BRACKET_RETURN");
  IElementType BRACKET_SETUP = new RobotFrameworkElementType("BRACKET_SETUP");
  IElementType BRACKET_TAGS = new RobotFrameworkElementType("BRACKET_TAGS");
  IElementType BRACKET_TEARDOWN = new RobotFrameworkElementType("BRACKET_TEARDOWN");
  IElementType BRACKET_TEMPLATE = new RobotFrameworkElementType("BRACKET_TEMPLATE");
  IElementType BRACKET_TIMEOUT = new RobotFrameworkElementType("BRACKET_TIMEOUT");
  ...
  IElementType FOR_IN_RANGE_DOUBLE_ARGUMENT = new RobotFrameworkElementType("FOR_IN_RANGE_DOUBLE_ARGUMENT");
  IElementType FOR_IN_RANGE_SINGLE_ARGUMENT = new RobotFrameworkElementType("FOR_IN_RANGE_SINGLE_ARGUMENT");
  IElementType FOR_IN_RANGE_TRIPLE_ARGUMENT = new RobotFrameworkElementType("FOR_IN_RANGE_TRIPLE_ARGUMENT");
  IElementType FOR_LOOPS = new RobotFrameworkElementType("FOR_LOOPS");
  IElementType FOR_LOOP_EXECUTION_LINE = new RobotFrameworkElementType("FOR_LOOP_EXECUTION_LINE");
  ...
  IElementType SETTING_LINE = new RobotFrameworkElementType("SETTING_LINE");
  IElementType SETTING_LIST = new RobotFrameworkElementType("SETTING_LIST");
  IElementType SETTING_LIST_OR_ELLIPSES = new RobotFrameworkElementType("SETTING_LIST_OR_ELLIPSES");
  ...
  IElementType TEST_CASE_SETTING = new RobotFrameworkElementType("TEST_CASE_SETTING");
  IElementType TEST_CASE_SETTING_LINE = new RobotFrameworkElementType("TEST_CASE_SETTING_LINE");
  ...
  IElementType VARIABLE_LINE = new RobotFrameworkElementType("VARIABLE_LINE");

  IElementType ARRAY_ASSIGNABLE_IN_VARIABLES_TBL = new RobotFrameworkTokenType("ARRAY_ASSIGNABLE_IN_VARIABLES_TBL");
  ...
  IElementType ASSIGNABLE_IN_VARIABLES_TBL = new RobotFrameworkTokenType("ASSIGNABLE_IN_VARIABLES_TBL");
  IElementType ASSIGNMENT_TOKEN = new RobotFrameworkTokenType("ASSIGNMENT_TOKEN");
  IElementType BRACKET_ARGUMENTS_TOKEN = new RobotFrameworkTokenType("BRACKET_ARGUMENTS_TOKEN");
  IElementType BRACKET_DOCUMENTATION_TOKEN = new RobotFrameworkTokenType("BRACKET_DOCUMENTATION_TOKEN");
  IElementType BRACKET_RETURN_TOKEN = new RobotFrameworkTokenType("BRACKET_RETURN_TOKEN");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ARGUMENT_DEFINITION) {
        ...
        return new RobotFrameworkBracketArgumentsImpl(node);
      }
      else if (type == BRACKET_DOCUMENTATION) {
        return new RobotFrameworkBracketDocumentationImpl(node);
      }
      else if (type == BRACKET_RETURN) {
        return new RobotFrameworkBracketReturnImpl(node);
      }
      else if (type == BRACKET_SETUP) {
        return new RobotFrameworkBracketSetupImpl(node);
      }
      else if (type == BRACKET_TAGS) {
        return new RobotFrameworkBracketTagsImpl(node);
      }
      else if (type == BRACKET_TEARDOWN) {
        return new RobotFrameworkBracketTeardownImpl(node);
      }
      else if (type == BRACKET_TEMPLATE) {
        return new RobotFrameworkBracketTemplateImpl(node);
      }
      else if (type == BRACKET_TIMEOUT) {
        return new RobotFrameworkBracketTimeoutImpl(node);
      }
      ...
      else if (type == FOR_IN_RANGE_DOUBLE_ARGUMENT) {
        return new RobotFrameworkForInRangeDoubleArgumentImpl(node);
      }
      else if (type == FOR_IN_RANGE_SINGLE_ARGUMENT) {
        return new RobotFrameworkForInRangeSingleArgumentImpl(node);
      }
      else if (type == FOR_IN_RANGE_TRIPLE_ARGUMENT) {
        return new RobotFrameworkForInRangeTripleArgumentImpl(node);
      }
      else if (type == FOR_LOOPS) {
        return new RobotFrameworkForLoopsImpl(node);
      }
      else if (type == FOR_LOOP_EXECUTION_LINE) {
        return new RobotFrameworkForLoopExecutionLineImpl(node);
      }
      ...
      else if (type == FOR_LOOP_IN_RANGE_PREFIX) {
        return new RobotFrameworkForLoopInRangePrefixImpl(node);
      }
      else if (type == FOR_LOOP_PREFIX) {
        return new RobotFrameworkForLoopPrefixImpl(node);
      }
      ...
      else if (type == INDENTED_VARIABLE_ASSIGNMENT_TO_KEYWORD) {
        return new RobotFrameworkIndentedVariableAssignmentToKeywordImpl(node);
      }
      ...
      else if (type == TEST_CASE_SETTING) {
        return new RobotFrameworkTestCaseSettingImpl(node);
      }
      else if (type == TEST_CASE_SETTING_LINE) {
        return new RobotFrameworkTestCaseSettingLineImpl(node);
      }
      ...
      else if (type == VARIABLE_LINE) {
        return new RobotFrameworkVariableLineImpl(node);
      }
