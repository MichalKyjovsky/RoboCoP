...
public class RobotFrameworkForInRangeTripleArgumentImpl extends ASTWrapperPsiElement implements RobotFrameworkForInRangeTripleArgument {

  public RobotFrameworkForInRangeTripleArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitForInRangeTripleArgument(this);
  }
