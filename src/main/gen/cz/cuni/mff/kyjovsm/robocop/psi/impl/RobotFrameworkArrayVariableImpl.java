...
public class RobotFrameworkArrayVariableImpl extends ASTWrapperPsiElement implements RobotFrameworkArrayVariable {

  public RobotFrameworkArrayVariableImpl(@NotNull ASTNode node) {
    super(node);
  }
