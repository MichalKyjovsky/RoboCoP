...
public class RobotFrameworkGenericSettingNameImpl extends ASTWrapperPsiElement implements RobotFrameworkGenericSettingName {

  public RobotFrameworkGenericSettingNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitGenericSettingName(this);
  }
