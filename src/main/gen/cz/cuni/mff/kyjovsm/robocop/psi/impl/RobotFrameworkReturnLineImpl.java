...
public class RobotFrameworkReturnLineImpl extends ASTWrapperPsiElement implements RobotFrameworkReturnLine {

  public RobotFrameworkReturnLineImpl(@NotNull ASTNode node) {
    super(node);
  }
