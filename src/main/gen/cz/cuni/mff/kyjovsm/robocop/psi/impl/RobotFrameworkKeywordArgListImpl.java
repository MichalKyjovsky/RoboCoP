...
public class RobotFrameworkKeywordArgListImpl extends ASTWrapperPsiElement implements RobotFrameworkKeywordArgList {

  public RobotFrameworkKeywordArgListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitKeywordArgList(this);
  }
