...
public class RobotFrameworkForLoopsImpl extends ASTWrapperPsiElement implements RobotFrameworkForLoops {

  public RobotFrameworkForLoopsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitForLoops(this);
  }
