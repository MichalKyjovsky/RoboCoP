...
public class RobotFrameworkVariableLineImpl extends ASTWrapperPsiElement implements RobotFrameworkVariableLine {

  public RobotFrameworkVariableLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitVariableLine(this);
  }
