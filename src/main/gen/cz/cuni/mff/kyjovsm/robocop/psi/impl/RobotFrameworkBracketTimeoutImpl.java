...
public class RobotFrameworkBracketTimeoutImpl extends ASTWrapperPsiElement implements RobotFrameworkBracketTimeout {

  public RobotFrameworkBracketTimeoutImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitBracketTimeout(this);
  }
