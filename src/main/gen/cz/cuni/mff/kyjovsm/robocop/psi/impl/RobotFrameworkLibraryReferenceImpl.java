...
public class RobotFrameworkLibraryReferenceImpl extends RobotFrameworkNamedElementImpl implements RobotFrameworkLibraryReference {

  public RobotFrameworkLibraryReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
