...
public class RobotFrameworkTestCaseNameImpl extends ASTWrapperPsiElement implements RobotFrameworkTestCaseName {

  public RobotFrameworkTestCaseNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestCaseName(this);
  }
