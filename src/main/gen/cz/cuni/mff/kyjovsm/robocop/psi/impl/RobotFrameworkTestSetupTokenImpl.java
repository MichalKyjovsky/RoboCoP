...
public class RobotFrameworkTestSetupTokenImpl extends ASTWrapperPsiElement implements RobotFrameworkTestSetupToken {

  public RobotFrameworkTestSetupTokenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitTestSetupToken(this);
  }
