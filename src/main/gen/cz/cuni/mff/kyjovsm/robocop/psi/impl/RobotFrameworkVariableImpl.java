...
public class RobotFrameworkVariableImpl extends ASTWrapperPsiElement implements RobotFrameworkVariable {

  public RobotFrameworkVariableImpl(@NotNull ASTNode node) {
    super(node);
  }
