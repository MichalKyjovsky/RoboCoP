...
public class RobotFrameworkForLoopValueListImpl extends ASTWrapperPsiElement implements RobotFrameworkForLoopValueList {

  public RobotFrameworkForLoopValueListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RobotFrameworkVisitor visitor) {
    visitor.visitForLoopValueList(this);
  }
