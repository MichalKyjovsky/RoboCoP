...
/**
 * Purpose of this class is to define dependency between the Tokens and the
 * standard keys defined by DefaultLanguageHighlighterColors class.
 */
public class RobotFrameworkSyntaxHighlighter extends SyntaxHighlighterBase {
  /**
   * @return The implementation of the adapter of JFlex lexer
   * RobotFrameworkLexerAdapter to adapt the the IntelliJ
   * Platform Lexer API.
   */
  @Override
  ...
  public static final TextAttributesKey HEADER =
          createTextAttributesKey("RF_HEADER",
                  DefaultLanguageHighlighterColors.CONSTANT);
  public static final TextAttributesKey SETTINGS =
          createTextAttributesKey("RF_BRACKET_SETTING",
                  DefaultLanguageHighlighterColors.METADATA);
  public static final TextAttributesKey NAMES =
          createTextAttributesKey("RF_NAMES",
                  DefaultLanguageHighlighterColors.KEYWORD);
  public static final TextAttributesKey DEFINITIONS =
          createTextAttributesKey("RF_DEFINITIONS",
                  DefaultLanguageHighlighterColors.FUNCTION_DECLARATION);
  public static final TextAttributesKey DOCUMENTATION =
          createTextAttributesKey("RF_DOCUMENTATION",
                  DefaultLanguageHighlighterColors.DOC_COMMENT);
  public static final TextAttributesKey ARGUMENTS =
          createTextAttributesKey("RF_ARGUMENTS",
                  DefaultLanguageHighlighterColors.STRING);
  public static final TextAttributesKey TAGS =
          createTextAttributesKey("RF_TAGS",
                  DefaultLanguageHighlighterColors.STRING);
  public static final TextAttributesKey ERROR =
          createTextAttributesKey("ERROR",
                  DefaultLanguageHighlighterColors.INVALID_STRING_ESCAPE);
  public static final TextAttributesKey COMMENT =
          createTextAttributesKey("COMMENT",
                  DefaultLanguageHighlighterColors.LINE_COMMENT);
  public static final TextAttributesKey INTEGER =
          createTextAttributesKey("INTEGER",
                  DefaultLanguageHighlighterColors.NUMBER);
  public static final TextAttributesKey ASSIGNMENT =
          createTextAttributesKey("ASSIGNMENT",
                  DefaultLanguageHighlighterColors.INSTANCE_FIELD);
  public static final TextAttributesKey COLUMN_SEPARATOR =
          createTextAttributesKey("COLUMN_SEPARATOR",
                  DefaultLanguageHighlighterColors.COMMA);
  public static final TextAttributesKey VARIABLES =
          createTextAttributesKey("VARIABLES",
                  DefaultLanguageHighlighterColors.INSTANCE_FIELD);

  private static final TextAttributesKey[] TABLES_HEADER_KEYS =
          new TextAttributesKey[]{HEADER};
  private static final TextAttributesKey[] SETTINGS_KEYS =
          new TextAttributesKey[]{SETTINGS};
  private static final TextAttributesKey[] KEYWORD_NAME_KEYS =
          new TextAttributesKey[]{NAMES};
  private static final TextAttributesKey[] DEFINITIONS_KEYS =
          new TextAttributesKey[]{DEFINITIONS};
  private static final TextAttributesKey[] DOCUMENTATION_KEYS =
          new TextAttributesKey[]{DOCUMENTATION};
  private static final TextAttributesKey[] ARGUMENT_KEYS =
          new TextAttributesKey[]{ARGUMENTS};
  private static final TextAttributesKey[] TAGS_KEYS =
          new TextAttributesKey[]{TAGS};
  private static final TextAttributesKey[] ERROR_KEYS =
          new TextAttributesKey[]{ERROR};
  private static final TextAttributesKey[] COMMENT_KEYS =
          new TextAttributesKey[]{COMMENT};
  private static final TextAttributesKey[] INTEGER_KEYS =
          new TextAttributesKey[]{INTEGER};
  private static final TextAttributesKey[] ASSIGNMENT_KEY =
          new TextAttributesKey[]{ASSIGNMENT};
  private static final TextAttributesKey[] COLUMN_SEPARATOR_KEYS =
          new TextAttributesKey[]{COLUMN_SEPARATOR};
  private static final TextAttributesKey[] VARIABLES_KEYS =
          new TextAttributesKey[]{VARIABLES};

  /**
   * @param tokenType Token to be recognized for colouring.
   * @return Standard keys defined by DefaultLanguageHighlighterColors class
   * defined onto ours tokens.
   */
  @Override
